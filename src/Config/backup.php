...
return [
    ...
    'backup' => [
        ...
        'source' => [
             ...
             */
            /*
             * O dump do banco depende do binário do cliente (mysqldump,
             * pg_dump, sqlite3) estar disponível no servidor. Em hospedagem
             * compartilhada onde ele não existe, esvazie esta lista: no SQLite
             * o próprio arquivo do banco já entra no backup de arquivos.
             */
            'databases' => [
    ...
    'notifications' => [
        ...
        'mail' => [
            // O spatie valida este endereço no boot, então ele não pode ficar
            // vazio mesmo quando as notificações por e-mail não são usadas.
            'to' => env('BACKUP_MAIL_TO', 'backup@example.com'),
